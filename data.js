    ...
    math: {
        ...
        topics: [
            ...
            },
            {
                title: "Integers (ℤ)",
                emoji: "➕➖",
                definition: "Integers include all whole numbers AND their negatives — every number with no fractional part.",
                facts: [
                    "<b>Symbol:</b> ℤ (from the German word <i>Zahlen</i>, meaning 'numbers').",
            ...
            },
            {
                ...
                facts: [
                    "<b>Symbol:</b> ℚ (from <i>quotient</i>, another word for 'fraction').",
                    "<b>Examples:</b> ½, -¾, 5 (= 5⁄1), 0.75 (= ¾), -2.5, 0 (0⁄1).",
                    "<b>Every integer is also rational</b> — just write it over 1 (e.g. 7 = 7⁄1).",
                    "<b>Terminating decimals</b> (0.5) and <b>repeating decimals</b> (0.333…) are always rational."
                ],
            ...
            },
            {
                ...
                emoji: "♾️",
                definition: "Irrational numbers CANNOT be written as a simple fraction. Their decimal form goes on forever WITHOUT ever repeating.",
                facts: [
            ...
            },
            {
                ...
                facts: [
                    ...
                    "<b>NOT real:</b> √(-1), the square root of any negative number, and infinity (∞)."
                ],
                eli5: "Real numbers are ALL the numbers put together — every integer, every fraction, every weird decimal like π. If you can point to it somewhere on a number line that stretches from -∞ to +∞, it's real!"
            },
            {
                title: "Even & Odd Numbers",
                emoji: "⚖️",
                definition: "An EVEN number is divisible by 2 with no remainder. An ODD number is NOT divisible by 2 — dividing it by 2 always leaves a remainder of 1.",
                facts: [
                    ...
                    "<b>0 is EVEN</b> (because 0 ÷ 2 = 0 exactly — no remainder)."
                ],
                eli5: "Even numbers LOVE to make pairs! 6 cookies can be split perfectly between 2 friends (3 each). Odd numbers always leave one cookie sitting alone — the remainder that has nobody to pair up with!"
            },
            {
                ...
                facts: [
                    ...
                    "<b>Every composite can be written as a product of primes</b> (called prime factorisation)."
                ],
        ...
        topics: [
            {
                ...
                emoji: "🌿",
                definition: "The movement of water, minerals, and food from one part of a plant to another using specialised tissues called xylem and phloem.",
                facts: [
                    ...
                    "<b>Transpiration:</b> Loss of water vapour from leaves — pulls water up through the xylem.",
            ...
            },
            {
                ...
                facts: [
                    ...
                    "<b>Capillaries:</b> Tiny vessels where gases, nutrients and wastes are exchanged with cells.",
        ...
        topics: [
            {
                ...
                facts: [
                    "<b>Atom:</b> The smallest particle of an element that takes part in a chemical reaction.",
            ...
            },
            {
                ...
                facts: [
                    "<b>Metals:</b> Shiny, malleable (hammered into sheets), ductile (drawn into wires), good conductors of heat & electricity.",
    ...
    physics: {
        ...
        topics: [
            ...
            },
            {
                title: "Electricity",
                emoji: "🔌",
                definition: "The flow of electric charges (usually electrons) through a conductor, carrying energy that powers our devices.",
                facts: [
                    "<b>Conductor:</b> Material that lets electricity pass easily (e.g. copper, aluminium).",
